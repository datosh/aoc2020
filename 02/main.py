...
num_correct_new_passwords = 0

for line in s.splitlines():
    if check_password_policy(line) == True:
        num_correct_old_passwords = num_correct_old_passwords + 1
    if check_new_password_policy(line) == True:
        num_correct_new_passwords = num_correct_new_passwords + 1

print("Old: ", num_correct_old_passwords)
print("New: ", num_correct_new_passwords)